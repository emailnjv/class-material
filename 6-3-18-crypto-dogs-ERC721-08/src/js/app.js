...
function createDogDiv(image, name, dogId, age ){
    var $cardContainer;
    var $cardBody;
    var $h5;
    var $p;
    ...
    $cardBody.append($dogImg, $h5, $p_dog_id, $p);
...
App = {
    ...
    showPricesOfDogs: function() {
        ...
        App.contracts.Sale.deployed().then(function(instance) {
            ...
            for (var i = 0; i < dogTokens.length; i++) {
                promises.push(SaleInstance.tokenIdToAuction(dogTokens[i][2].toNumber()));
            }
    ...
    sellDog: function(event){
        ...
        App.contracts.Sale.deployed().then(function(instance) {
            ...
            return saleInstance.createAuction(tokenId, amount);
